...
cp "${ROOT_DIR}/market-flow.html" "${OUT_DIR}/market-flow.html"
...
cp "${ROOT_DIR}/market-flow.js" "${OUT_DIR}/market-flow.js"
...
cp "${ROOT_DIR}/market-flow.css" "${OUT_DIR}/market-flow.css"
