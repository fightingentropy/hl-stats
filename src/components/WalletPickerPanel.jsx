...
function getPinnedWalletLabel(wallet) {
            ...
            {PINNED_WALLETS.map((wallet) => {
              ...
              return (
                <Link
                  ...
                  className={cx(
                    "qf-wallet-chip inline-flex min-h-10 items-center rounded-sm border px-3 text-sm transition",
                    isActive
